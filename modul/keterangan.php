<title>Cov Diagnosis</title>
<h2 class='text text-primary'>Info Penyakit</h2>
<hr>
<div class="row">
  ...
  while ($r = mysqli_fetch_array($hasil)) {
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" data-aos="fade-right">
        <div class="card text-center">
          <img class="card-img-top img-bordered-sm" src="<?php echo 'gambar/' . $r['gambar']; ?>" alt="" width="100%" height="40%">
